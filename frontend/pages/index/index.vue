<template>
	<view class="content">
		<view class="title">欢迎来到王者聊天室</view>
		<view class="head" @click="modify">
			<image :src="'../../static/images/'+nowimg+'.'+imgExtension[nowimg]" mode="aspectFill" class="head-img"></image>
		...
		<view class="modify" :animation="animationData">
			...
			<view class="modfiy-mian">
				<view v-for="(e,index) in img" :key="index" class="us-img" @tap="selected(index)">
					<image :src="'../../static/images/' + e.i + '.' + imgExtension[e.i]" mode="aspectFit"></image>	
					<view class="dd">
		...
		<!-- <view>
			<button @tap="gototest">tiaozhuan</button>
		</view> -->
...
<style lang="scss">
	...
	.join{
		...
		box-shadow:0px 36rpx 68rpx -8rpx rgba(137, 137, 204, 1.0);
		border-radius: 50%;
		font-size:28rpx;
		font-weight:600;
		text-align: center;
